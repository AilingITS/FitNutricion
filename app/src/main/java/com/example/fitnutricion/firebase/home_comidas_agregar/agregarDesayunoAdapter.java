...
public class agregarDesayunoAdapter extends RecyclerView.Adapter<agregarDesayunoAdapter.agregarDesayunoHolder>{
    ...
    public agregarDesayunoAdapter(Context context, View view,ArrayList<agregarDesayuno> list) {
    ...
    @NotNull
    @Override
    public agregarDesayunoAdapter.agregarDesayunoHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_list_agregar_comida_to_receta,parent,false);
        return new agregarDesayunoAdapter.agregarDesayunoHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull agregarDesayunoAdapter.agregarDesayunoHolder holder, int position) {

        mAuth = FirebaseAuth.getInstance();
        userID = mAuth.getCurrentUser().getUid();
        dbRef = FirebaseDatabase.getInstance().getReference().child("users").child(userID).child("recetas");

        agregarDesayuno foods = list.get(position);
    ...
    public static class agregarDesayunoHolder extends RecyclerView.ViewHolder{
        ...
        public agregarDesayunoHolder(View itemView){
            super(itemView);
