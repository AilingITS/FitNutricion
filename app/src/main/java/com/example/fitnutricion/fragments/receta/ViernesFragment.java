...
import com.example.fitnutricion.firebase.receta.Viernes;
import com.example.fitnutricion.firebase.receta.lunesAdapter;
import com.example.fitnutricion.firebase.receta.viernesAdapter;
...
public class ViernesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = vista.findViewById(R.id.receta_viernes_List);

        mAuth = FirebaseAuth.getInstance();
        userID = mAuth.getCurrentUser().getUid();
        dbRef = FirebaseDatabase.getInstance().getReference().child("users").child(userID).child("recetas").child("Viernes");
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        list = new ArrayList<>();
        myAdapter = new viernesAdapter(getContext(),list);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    Viernes foods = dataSnapshot.getValue(Viernes.class);
                    list.add(foods);
                }
