...
public class EditarComidaFragment extends Fragment {
    ...
    public EditarComidaFragment(String comidaID) {
        this.comidaID = comidaID;
    }

    public EditarComidaFragment() {

    }

    public static EditarComidaFragment newInstance(String param1, String param2) {
        EditarComidaFragment fragment = new EditarComidaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_editar_comida, container, false);
        ...
        dbRef.child(comidaID).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        dbRef.child(comidaID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    public void SaveInfoToDatabase () {
        ...
        if (TextUtils.isEmpty(nombre)) {
            ...
            dbRef.child(comidaID).updateChildren(desayunoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull @NotNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(getActivity(),R.string.stringCambiosGuardadosCorrectamente, Toast.LENGTH_SHORT).show();
